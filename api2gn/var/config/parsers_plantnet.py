...
class PlantNetReunion(PlantNetParser):
    ...
    description = "Observations Pl@ntNet sur l'emprise Réunion"

    # géométrie d’emprise
    geometry = REUNION_POLYGON

    # liste des espèces autorisées (facultatif : laisser vide pour *toutes*)
    scientific_names = EXAMPLE_SPECIES
